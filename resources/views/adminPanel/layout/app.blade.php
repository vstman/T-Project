        ...
        <div class="main-header">
            <div class="main-header-logo">
                ...
                <div class="logo-header" data-background-color="dark">
                    <a href="#" class="logo">
                        <img
                            src="{{asset('adminPanel/assets/img/kaiadmin/logo_light.svg')}}"
                            alt="navbar brand"
                            class="navbar-brand"
                            height="20"
                        />
                    ...
                    <ul class="navbar-nav topbar-nav ms-md-auto align-items-center">
                            ...
                            >
                                    ...
                                    <div class="message-notif-scroll scrollbar-outer">
                                        <div class="notif-center">
                                            <a href="#">
                                                <div class="notif-img">
                                                    <img
                                                        src="{{asset('adminPanel/assets/img/jm_denis.jpg')}}"
                                                        alt="Img Profile"
                                                    />
                                                </div>
                                            ...
                                            <a href="#">
                                                <div class="notif-img">
                                                    <img
                                                        src="{{asset('adminPanel/assets/img/chadengle.jpg')}}"
                                                        alt="Img Profile"
                                                    />
                                                </div>
                                                <div class="notif-content">
                                            ...
                                            <a href="#">
                                                <div class="notif-img">
                                                    <img
                                                        src="{{asset('adminPanel/assets/img/mlane.jpg')}}"
                                                        alt="Img Profile"
                                                    />
                                                </div>
                                                <div class="notif-content">
                                ...
                                Ready for the meeting today...
                                            ...
                                            <a href="#">
                                                <div class="notif-img">
                                                    <img
                                                        src="{{asset('adminPanel/assets/img/talha.jpg')}}"
                                                        alt="Img Profile"
                                                    />
                                                </div>
                                                <div class="notif-content">
                              ...
                              <span class="block">
                                Rahmad commented on Admin
                                            ...
                                            <a href="#">
                                                <div class="notif-img">
                                                    <img
                                                        src="{{asset('adminPanel/assets/img/profile2.jpg')}}"
                                                        alt="Img Profile"
                                                    />
                                                </div>
                                                <div class="notif-content">
                        ...
                        <li class="nav-item topbar-user dropdown hidden-caret">
                            ...
                            >
                                <div class="avatar-sm">
                                    <img
                                        src="{{asset('adminPanel/assets/img/profile.jpg')}}"
                                        alt="..."
...
<!-- jQuery Scrollbar -->
<script src="{{asset('adminPanel/assets/img/kaiadmin/logo_light.svg')}}assets/js/plugin/jquery-scrollbar/jquery.scrollbar.min.js"></script>
